...
CrossPoster автоматически отслеживает новые посты в социальных сетях и репостит их в другие подключенные платформы. Ниже приведена блок-схема основного процесса:

Для детального ознакомления с процессом кросспостинга см. файл [CROSSPOSTING_FLOWCHART.md](../CROSSPOSTING_FLOWCHART.md).